...
public class PatinaDataMapProvider extends DataMapProvider {
    public PatinaDataMapProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> lookupProvider) {
